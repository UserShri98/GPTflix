    ...
    return (
        <div className="pt-[35%] md:pt-[10%] flex justify-center">
            <form className="w-full md:w-1/2 bg-black grid grid-cols-12" onSubmit={(e)=>e.preventDefault()}>
             ...
             type="text"
             ref={searchText}
             className="p-2 m-2 md:p-4 md:m-4 col-span-9 text-white"
             placeholder={lang[langKey].gptSearchPlaceholder}
             />
             <button className="col-span-3 m-2 md:m-4 py-2 px-2 md:px-4 bg-red-700 text-white rounded-lg text-sm md:text-base" 
